    ...
    >
      ...
      <div style={{ padding: "1rem", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        >
          ...
          <div style={{ fontSize: 12.5, color: colors.textSecondary, lineHeight: 1.5, textAlign: "justify" }}>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: "auto", paddingTop: 14 }}>
          <Link to={`/profile/${candidate.id}`} style={{ flex: 1, minWidth: 0, display: "block" }}>
            <Button
              ...
              style={{ width: "100%", paddingInline: 8, overflow: "hidden", textOverflow: "ellipsis" }}
            >
          ...
          <Link to={`/analysis/${candidate.id}`} style={{ flex: 1.6, minWidth: 0, display: "block" }}>
            <Button
              ...
              style={{ width: "100%", paddingInline: 8, overflow: "hidden", textOverflow: "ellipsis" }}
            >
              {compact ? strings.candidateCard.analyzeCompact : strings.candidateCard.analyzeShort}
            </Button>
          </Link>
        </div>
      </div>
